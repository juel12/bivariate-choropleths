...
This app was created using shiny [@Chang.2018] with R version 3.5.2 (2018-12-20) and later updated with R version 4.3.1 (2023-06-16). Its purpose is to create bivariate choropleths.
...
After the "Create plot" button has been clicked, the bivariate choreopleth and a legend will be rendered. A mapshot of the bivariate choreopleth can be downloaded using "webshot" [@webshot]. However, as this requires "PhantomJS", you might need to install it first using the following code:
